  ...
  <div class="col-lg-8 pb-5">
    <form action="/categories/{{ $category->slug }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $category->name) }}" id="name"required>
        @error('name')
      ...
      <div class="mb-3">
        ...
        <input type="text" value="{{ old('slug', $category->slug)}}" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" required>
        @error('name')
          <div class="invalid-feedback">
            {{ $message }}  
          </div>   
